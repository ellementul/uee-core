...
## Задачи:
- Очистить стейт модуль от внутренего хранилища.
- Наследовать от стейт модуля модуль зависимый от системы
- Создать мета модуль из системного и определить в нем существование трех систем: Modules, Store
